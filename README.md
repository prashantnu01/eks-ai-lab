...
| 4 | Karpenter | Dynamic / Spot node provisioning | 🔜 |
...
| **Performance** | Right-sized t3.medium, resource requests/limits |
| **Cost** | Tagged resources, delete-when-idle discipline |
